    ...
    <div class="login-main">    
         <div class="login-head">
            ...
            <div class="login-block">
                <form method="POST" action='<c:url value="userservlet?method=login"></c:url>'>
                <h2><c:out value="${requestScope.errormsg }"></c:out></h2>   
                    <div class="form-group row">
                        <label for="email" class="col-md-2 col-sm-2" style="margin-left: 5%">邮箱</label>
                        <div class="col-md-6 col-sm-6">
                            <input id="email" type="text" class="form-control" name="email"  value='<c:out value="${requestScope.form.email}"></c:out>'   autofocus>
                        </div>
                    ...
                    <h3>没有账号?<a href="<c:url value='/userservlet?method=regist'></c:url>">  点击注册</a></h3>                
                </form>
